...
const Profile = () => {
    ...
    const onSubmit = (e) => {
        ...
        axios.put(API_URL, profile).then(res => {
    ...
    return (
        ...
        <form className='add-form' onSubmit={onSubmit}>
            ...
            <div className='form-control'>
                ...
                onChange={(e) => setProfile({...profile, emergencyFirstName: e.target.value})}
                />
            </div>
            <div className='form-control'>
                ...
                onChange={(e) => setProfile({...profile, emergencyLastName: e.target.value})}
                />
            </div>
            <div className='form-control'>
                <label style={{ marginRight: 10 }}>Cell Phone: </label>
                ...
                onChange={(e) => setProfile({...profile, emergencyCellPhone: e.target.value})}
                />
            </div>            

            <input style={{ borderStyle: 'solid', marginTop: 20 }} type='submit' value='Save Task' />
            </form>
            </div>
    )
}
